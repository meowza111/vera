...
import { LiveAlertService } from './services/liveAlertService.js';
...
class TitanBot extends Client {
  ...
  async start() {
    try {
      ...
      this.liveAlertService = new LiveAlertService(this);
      this.liveAlertService.start();
  ...
  async shutdown(reason = 'UNKNOWN') {
    ...
    try {
      ...
      if (this.liveAlertService) {
        logger.info('Stopping live alert monitor...');
        this.liveAlertService.stop();
        logger.info('✅ Live alert monitor stopped');
      }
